-- CreateEnum
CREATE TYPE "LeadSource" AS ENUM ('REFERRAL', 'WEBSITE', 'COLD_OUTREACH', 'SOCIAL_MEDIA', 'EMAIL_CAMPAIGN', 'EVENT', 'PARTNER', 'OTHER');
...
CREATE TABLE "Lead" (
    ...
    "userId" TEXT NOT NULL,
    "pipelineOrder" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
